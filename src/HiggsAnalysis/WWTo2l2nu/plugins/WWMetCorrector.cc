#include "HiggsAnalysis/WWTo2l2nu/plugins/WWMetCorrector.h"

// Lorentz vector
typedef math::XYZTLorentzVector LorentzVector;

WWMetCorrector::WWMetCorrector(const edm::ParameterSet& iConfig)
{
...
WWMetCorrector::~WWMetCorrector()
{
}

// ------------ method called to produce the data  ------------
void
WWMetCorrector::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  using namespace std;
...
void 
WWMetCorrector::beginJob(const edm::EventSetup&)
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
WWMetCorrector::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(WWMetCorrector);
