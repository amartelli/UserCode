...
void doComparisonPlots(){
  ...
  ////////////////////////////  da qui forse e' utile
   ...
   std::string plotDirOut = "2011vs2012_false_noSh";
   
    std::string f11_h1 = plotDir1+"/results_EB_HIGH_scE_reg_2011.root";
    std::string f12_h1 = plotDir1+"/results_EB_HIGH_scE_reg_2012.root";
    std::string f11_l1 = plotDir1+"/results_EB_LOW_scE_reg_2011.root";
    std::string f12_l1 = plotDir1+"/results_EB_LOW_scE_reg_2012.root";

    std::string f11_h2 = plotDir2+"/results_EB_HIGH_scE_reg_2011.root";
    std::string f12_h2 = plotDir2+"/results_EB_HIGH_scE_reg_2012.root";
    std::string f11_l2 = plotDir2+"/results_EB_LOW_scE_reg_2011.root";
    std::string f12_l2 = plotDir2+"/results_EB_LOW_scE_reg_2012.root";
    ...
    // pad settings                                                                     
    TH1F *hPad = (TH1F*)gPad->DrawFrame(20,-0.004,100,0.014);
    ...
    tspec->AddEntry(g2012_h1,"2012 EB hR9","PL");
    tspec->AddEntry(g2011_h1,"2011 EB hR9","PL");
    tspec->AddEntry(g2012_l1,"2012 EB lR9","PL");
    tspec->AddEntry(g2011_l1,"2011 EB lR9","PL");
